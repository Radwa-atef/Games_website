<template>
<div class="mainDiv">
    <h2 style="color:#be1e2d;text-align: center;margin-top:20px">Most popular</h2>
    <div class="borderStyle"></div>
    <br/>
    <el-row >
   <div v-if="getFilteredGame.length!=null">
     <div v-for="(item,index) in games.slice(14,20)" :key="index">
